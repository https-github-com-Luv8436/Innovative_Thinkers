...
def main():
    try:
        ...
        cur.execute("INSERT INTO aadhar_database(aadhar_number , constituency ,  party_number , status , image1 , image2 , image3 ) VALUES (%s , %s , %s , %s , %s , %s , %s)", (aadhar , args.constituency , args.party_number , args.status , binary_1 , binary_2 , binary_3))
